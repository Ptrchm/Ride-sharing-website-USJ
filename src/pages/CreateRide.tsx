...
import { createRoute, getDriverDetails, createDriverApplication, verifyDriver } from "@/services/xanoApi";
          ...
          driverStatus === "pending" ? (
            <div className="max-w-xl mx-auto bg-card border border-border rounded-xl p-6 shadow-sm text-center">
              ...
              <p className="text-muted-foreground text-sm">
                Votre demande conducteur est en cours de vérification. Vous pourrez créer un trajet une fois approuvé.
              </p>
            </div>
